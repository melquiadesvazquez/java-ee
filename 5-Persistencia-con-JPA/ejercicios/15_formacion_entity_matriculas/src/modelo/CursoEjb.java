...
public class CursoEjb implements CursoEjbLocal {
	...
	@Override
	public List<Curso> getCursosMatriculados(String usuario) {
		Alumno alumno = em.find(Alumno.class, usuario);
		return alumno.getCursos();
	}
	
	@Override
	public List<Curso> getCursosDisponibles(String usuario) {		
		String jpql="Select c From Curso c ";
		jpql+=" Where c not in (";
		jpql+="Select c From Curso c ";
		jpql+="Join c.alumnos a Where a.usuario=?1)";
